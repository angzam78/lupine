...
int handle_cuSignalExternalSemaphoresAsync(conn_t *conn)
{
    ...
    if (request_id < 0)
        goto ERROR_0;
    lupine_intercept_result = cuSignalExternalSemaphoresAsync(extSemArray, paramsArray, numExtSems, stream);
...
int handle_cuWaitExternalSemaphoresAsync(conn_t *conn)
{
    ...
    if (request_id < 0)
        goto ERROR_0;
    lupine_intercept_result = cuWaitExternalSemaphoresAsync(extSemArray, paramsArray, numExtSems, stream);
